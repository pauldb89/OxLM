...
class HiddenVariableLM {
 ...
 public:
  ...
  ~HiddenVariableLM() { delete [] m_data; }
  ...
  int source_types() const { return m_hidden_labels.size(); }
  ...
  const Dict& source_label_set() const { return m_hidden_labels; }
  Dict& source_label_set() { return m_hidden_labels; }
