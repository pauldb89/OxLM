...
class GeneralConditionalNLM : public ConditionalNLM {
public:
...
public:
  ...
  GeneralConditionalNLM(const ModelData& config, const Dict& source_vocab, const Dict& target_vocab, const std::vector<int>& classes);
